...
const FAQ_ITEMS = [
  ...
  {
    q: "文献・論文をもとに整理した情報はどのくらい正確ですか？",
    a: "Anthropic社のClaude（最新モデル）を使用し、文献・論文をもとに臨床情報を整理しています。ただし情報には誤りが含まれる可能性があります。臨床での最終判断は必ず一次文献や専門家への確認のうえ行ってください。本ツールは臨床前の準備・情報収集・学習補助としてご活用ください。",
  },
  {
